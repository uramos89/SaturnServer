...
| ID | Domain | Confidence | Patterns | Last Used |
|----|--------|-----------|---------|-----------|
| TECH-01 | TypeScript/Node.js | 95% | Repository, Middleware | 2026-05-01 |
...
| ID | Pattern | Category | Confidence | Projects Applied |
|----|---------|----------|-----------|-----------------|
| P-01 | Repository | Data Access | 90% | SSH Connections, DB |
| P-02 | Observer | Monitoring | 85% | Server Metrics |
| P-03 | Strategy | AI Analysis | 80% | OBPA Cycle |
| P-04 | State Machine | Workflow | 85% | Incident Management |
...
| ID | Item | Priority | Source | Date Detected |
|----|------|---------|--------|---------------|
| TD-01 | Chunk size > 500KB in frontend build | Medium | Vite build warning | 2026-05-01 |
| TD-02 | No test suite configured | High | Project audit | 2026-05-01 |
| TD-03 | Some `any` types in TypeScript | Low | Code review | 2026-05-01 |

## 📈 Health Metrics

| Metric | Value | Trend |
|--------|-------|-------|
| Pattern Success Rate | 85% | Stable |
| Avg Feature Duration | — | — |
| Contract Violations | 0 | — |
| Ingest Coverage | Partial | — |

## 🔗 Quick Navigation

- [Root Contract](../CONTRACTS/ROOT_CONTRACT.md)
- [Tech Knowledge](../TECH/)
- [Functional Solutions](../FUNC/)
- [Architectural Patterns](../STRUCT/)
- [Audit Logs](../AUDIT/)
- [Parameters](../PARAMS/)
